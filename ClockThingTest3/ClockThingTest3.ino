...
//3) To set the color, select a color on the color wheel and hit "Select"
...
void set_time() {
  ...
  if (ble.buffer[0] == 't') {                                                 //For when the first character in the message is "t"
    ble.print(current_hr);                                                     //Print the hour that is being set on the phone
    ble.print(": ");                                                           //Print a colon and a space on the phone
    ble.print(current_min);                                                    //Print the minute that is being set on the phone
    ble.print(": ");                                                           //Print a colon and a space on the phone
    ble.println(current_sec);                                                  //Print the minute that is being set on the phone
...
void set_color() {                                          //Defines the function
  ...
  if (len == 0) return;                                      //For when there is no data; Do nothing
